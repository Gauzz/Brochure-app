...
public class VideoNode extends AnchorNode {
  ...
  public void setImage(AugmentedImage image) {
    ...
    // If any of the models are not loaded, then recurse when all are loaded.
      ...
      videoNode.setLocalScale(
              new Vector3(
                      (0.1f/(VIDEO_HEIGHT_METERS * (videoWidth / videoHeight))), (float) (0.1/VIDEO_HEIGHT_METERS), 0.1f));
    ...
    localScale.set(0.005f, 0.005f, 0.005f);
